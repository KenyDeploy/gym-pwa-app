...
export default function WorkoutApp() {
  ...
  const startWorkout = (plan) => {
    const sessionExercises = plan.exerciseIds
      .map(id => {
  ...
  const addSet = (exIdx) => {
    ...
    const updated = {
      ...
      exercises: activeSession.exercises.map(
        (exercise, idx) =>
          idx === exIdx
            ? {
                ...exercise,
  ...
  const copyPreviousSet = (
    ...
    if (!activeSession || setIdx === 0) return;
  ...
  const toggleSetDone = (
    ...
    const currentSet =
      activeSession.exercises[exIdx].sets[
        setIdx
      ];
    ...
    // Automatyczna przerwa po wykonaniu serii
    if (!currentSet.done) {
      startRestTimer(90);
    }
  };
...
RRULE:FREQ=DAILY
DTSTART:${getLocalDateString().replaceAll(
      '-',
      ''
    )}T${hh}${mm}00
DURATION:PT15M
...
END:VCALENDAR`;
  ...
  const completedCurrentSets =
    currentEx?.sets.filter(
      set => set.done
    ).length || 0;

  const totalCurrentSets =
  ...
  return (
    <div
      className={`min-h-screen ${bgMain} flex flex-col font-sans transition-colors duration-200 relative`}
    >
      ...
      {showSplash && (
        <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-neutral-950 text-white p-6 text-center">
          ...
          <div className="flex items-center gap-2 mt-3 text-[10px] text-neutral-500 uppercase tracking-widest">
            <Zap className="h-3 w-3 text-violet-400 animate-pulse" />
            <span>
              Przygotowujemy trening
            </span>
          </div>

          <div className="w-48 h-1.5 bg-neutral-800 rounded-full overflow-hidden mt-7">
            <div className="h-full w-full bg-gradient-to-r from-violet-500 via-indigo-500 to-blue-400 rounded-full animate-pulse" />
          </div>

          <div className="text-[9px] text-neutral-700 font-mono mt-4">
        ...
        {activeSession && (
          ...
          >
            ...
            <div className="relative">
              ...
              <Timer
                className={`h-4 w-4 ${accentText}`}
              />

              <span className="absolute -right-1 -top-1 w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" />

            </div>

            <span
              className={`font-mono text-sm font-black ${accentText}`}
            >
              {formatTime(
                timerSeconds
              )}
      ...
      <main className="flex-1 p-4 max-w-lg w-full mx-auto pb-28">
        ...
        {activeSession ? (
          ...
          <div className="space-y-4">
            ...
            <div
              className={`rounded-3xl border p-4 ${bgCard} shadow-sm`}
            >
              ...
              <div className="flex items-center justify-between gap-3">
                ...
                <div>
                  ...
                  <div
                    className={`text-[10px] font-black uppercase tracking-[0.18em] ${textMuted}`}
                  >
                    Ćwiczenie{' '}
                    {String(
                      activeExIdx + 1
                  ...
                  <div
                    className={`text-xs font-semibold mt-1 ${textMuted}`}
                  >
                    {currentExCategory}
                  </div>
                ...
                <div
                  className={`shrink-0 px-3 py-2 rounded-2xl text-xs font-black ${
                    isDark
              ...
              <div className="mt-4">
                ...
                <div className="flex justify-between items-center mb-1.5">
                  ...
                  <span
                    className={`text-[9px] font-black uppercase tracking-wider ${textMuted}`}
                  >
                    Postęp serii
                  </span>

                  <span
                    className={`text-[10px] font-black ${accentText}`}
                  >
                    {completedCurrentSets}
                    /
                    {totalCurrentSets}
            ...
            >
              ...
              <div className="flex items-end justify-between mb-4">
                ...
                <div>
                  ...
                  <div
                    className={`text-[10px] font-black uppercase tracking-[0.16em] ${textMuted}`}
                  >
                    Serie
                  </div>
                ...
                <div className="text-right">
                  ...
                  <div
                    className={`text-[10px] uppercase font-bold ${textMuted}`}
                  >
                    Tonaż
                  </div>

                  <div
                    className={`text-sm font-black ${accentText}`}
                  >
                    {currentExWeight}{' '}
                    kg
                  </div>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div className="flex-1 grid grid-cols-2 gap-2">
                            ...
                            <div>
                              ...
                              <label
                                className={`block text-[9px] font-black uppercase tracking-wider mb-1 ${textMuted}`}
                              >
                                Powtórzenia
                              </label>
                              ...
                              {previousSet && (
                                <div
                                  className={`text-[9px] text-center mt-1 ${textMuted}`}
                                >
                                  ostatnio:{' '}
                                  {previousSet.reps ||
                                    0}
                          ...
                          <div className="flex flex-col gap-1 shrink-0">
                            ...
                            <button
                              ...
                              title="Użyj poprzedniego wyniku"
                            >
                              ...
                              className={`w-9 h-9 rounded-xl flex items-center justify-center transition-all ${
                                set.done
                                  ...
                                  : isDark
                                    ...
                                    : 'bg-white border border-slate-200 text-slate-400 hover:text-emerald-500'
                              }`}
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className={`flex-1 py-3.5 rounded-2xl border text-xs font-black flex items-center justify-center gap-2 transition-all disabled:opacity-30 ${
                  isDark
          ...
          <>
            ...
            {activeTab ===
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  >
                    Wybierz plan i zacznij budować formę.
                  </p>
                ...
                <div className="grid grid-cols-3 gap-2">
                  ...
                  <div
                    className={`rounded-2xl border p-3 ${bgCard}`}
                  >

                    <div
                      className={`text-[9px] uppercase font-black ${textMuted}`}
                    >
                      Ten tydzień
                    </div>

                    <div
                      className={`text-xl font-black mt-1 ${accentText}`}
                    >
                      {workoutsThisWeek}
                    </div>

                    <div
                      className={`text-[9px] ${textMuted}`}
                    >
                      treningów
                    </div>
                ...
                <div>
                  ...
                  0 ? (
                    <div
                      className={`p-4 rounded-2xl border space-y-3 ${bgCard}`}
                    >
                      ...
                      <div
                        className={`grid grid-cols-4 gap-2 text-center pt-3 border-t ${
                          isDark
                            ? 'border-neutral-800'
                            : 'border-slate-200'
                        }`}
                      >
                        ...
                        <div>
                          ...
                          <div
                            className={`font-bold text-xs ${accentText}`}
                          >
                            {
                              workoutHistory[0]
                                .totalWeight
                    ...
                    <div
                      className={`p-4 rounded-2xl border text-center ${bgCard}`}
                    >
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p
                    className={`text-xs ${textMuted}`}
                  >
                    Kliknij dzień w kalendarzu, aby zobaczyć trening.
                  </p>

                </div>

                <div
                  className={`border rounded-2xl p-4 space-y-4 ${bgCard}`}
                >
                  ...
                  <div
                    className={`grid grid-cols-7 gap-1 text-center font-bold text-xs ${textMuted}`}
                  >
                ...
                {selectedHistoryDate && (
                  ...
                  >
                    ...
                    {historyForSelectedDate.length >
                    0 ? (
                      historyForSelectedDate.map(
                        h => (
                          <div
                            key={h.id}
                          ...
                          >
                            ...
                            <div className="flex justify-between items-center pr-8">
                              ...
                              <span
                                className={`font-black text-sm ${accentText}`}
                              >
                                {
                                  h.planName
                                }
              ...
              <div className="space-y-4">
                        ...
                        ex => {
                          ...
                          return (
                            <div
                              ...
                              className="flex justify-between items-center text-xs py-1.5 border-b border-slate-100 dark:border-neutral-800 last:border-0 gap-3"
                            >
                ...
                {statsSubTab ===
                  ...
                  <div className="space-y-4">
                    ...
                    <div
                      className={`p-4 rounded-2xl border space-y-4 ${bgCard}`}
                    >
                      ...
                      <div
                        className={`relative w-full h-80 rounded-2xl border flex items-center justify-between p-4 overflow-hidden ${
                          isDark
                      ...
                      <div className="space-y-2 pt-2">
                        ...
                        {(() => {
                          ...
                          if (
                            ...
                            return (
                              <p
                                className={`text-xs ${textMuted} text-center py-2`}
                              >
                  ...
                  p => (
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p
                          className={`text-xs ${textMuted} mt-0.5`}
                        >
                          {
                            p.exerciseIds
                              .length
            ...
            {activeTab ===
              ...
              <div className="space-y-4">
                ...
                <div
                  className={`border rounded-2xl divide-y ${bgCard} ${
                    isDark
                      ? 'divide-neutral-800'
                      : 'divide-slate-200'
                  }`}
                    ...
                    ex => (
                      ...
                      >
                        ...
                        <div>
                          ...
                          <div
                            className={`text-[9px] mt-0.5 ${textMuted}`}
                          >
                            {
                              ex.category
                            }
            ...
            {activeTab ===
              ...
              <div className="space-y-5">
                ...
                >
                  ...
                  <div
                    className={`flex items-center space-x-2 ${accentText}`}
                  >
                  ...
                  <p
                    className={`text-xs ${textMuted}`}
                  >
                    Po oznaczeniu serii jako wykonanej automatycznie uruchamia się 90 sekund przerwy.
                  </p>
                ...
                >
                  ...
                  <p
                    className={`text-xs ${textMuted}`}
                  >
                    Ustaw godzinę przypomnienia i pobierz plik `.ics` do kalendarza.
                  </p>
      ...
      {showStartModal && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          ...
          <div
            className={`border rounded-2xl p-4 max-w-xs w-full space-y-3 ${bgCard}`}
          >
            ...
            <div className="flex justify-between items-center">
              ...
              <div>
                ...
                <p
                  className={`text-[10px] mt-0.5 ${textMuted}`}
                >
                  Gotowy na trening?
                </p>
            ...
            0 ? (
              <div
                className={`text-xs text-center py-5 ${textMuted}`}
              >
                Nie masz jeszcze żadnego planu treningowego.
              </div>
            ) : (
              plans.map(
                p => (
      ...
      {summaryData && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          ...
          <div
            className={`border rounded-2xl p-5 max-w-sm w-full space-y-4 text-center ${bgCard}`}
          >
            ...
            <div>
              ...
              <p
                className={`text-xs mt-1 ${textMuted}`}
              >
                Dobra robota. Wynik został zapisany.
              </p>

            </div>

            <div
              className={`grid grid-cols-4 gap-2 py-3 border-y text-center ${
                isDark
                  ? 'border-neutral-800'
                  : 'border-slate-200'
              }`}
            >
              ...
              <div>
                ...
                <div
                  className={`font-bold text-sm ${accentText}`}
                >
                  {
      ...
      {!activeSession &&
        !showSplash && (
          <nav
            className={`fixed bottom-0 left-0 right-0 border-t p-2 flex justify-around z-40 backdrop-blur-md ${
              isDark
